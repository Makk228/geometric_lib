...
def test_perimeter_triangle(size, expected, correct):
    if correct:
...
def test_perimeter_square(size, expected, correct):
    if correct:
...
def test_perimeter_rectangle(size, expected, correct):
    if correct:
...
def test_perimeter_circle(size, expected, correct):
    if correct:
